...
var Adapter = Ember.Object.extend({
  ...
  */
  shouldBackgroundReloadAll: function(store, snapshotRecordArray) {
    Ember.deprecate('The default behavior of `shouldBackgroundReloadAll` will change in Ember Data 2.0 to always return true. If you would like to preserve the current behavior please override `shouldBackgroundReloadAll` in you adapter:application and return false.');
    return false;
  }
});
